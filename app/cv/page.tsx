...
export default function AudioPage() {
  return (
    <div className={styles.cvPage}>
      <div className={styles.cvPageContent}>
        <Title order={1}>Education</Title>
        <Title order={2}>University of Warwick</Title>
        <List>
          <ListItem>
            BEng, Mechanical Engineering & Manufacturing 2.1 (Sep 2017 - May
            2020)
          </ListItem>
          <ListItem>
            Dissertation: “Life Cycle Analysis Comparing Electric and Diesel
            Buses in Urban Environments” (Grade:1st)
          </ListItem>
        </List>
        <Divider />
        ...
        <List>
          <ListItem>
            ...
            Component Library used across 1200+ sites globally, including
            Execute (the lead trading platform for FX and Commodity Traders
            across JPM).
          </ListItem>
          <ListItem>
          ...
          <ListItem>
            Implemented Cypress Component Testing and Chromatic Visual
            Regression testing to enhance bug detection for each feature change,
            to ensure design consistency across the component library.
          </ListItem>
          <ListItem>
          ...
          <ListItem>
            Implemented cross-device compatibility, using responsive styling
            (CSS & Media Queries) to align with Figma specifications at given
            breakpoints.
          </ListItem>
          <ListItem>
        ...
        <List>
          <ListItem>
            Migrated Digital Platform NextJS Website to AWS ECS across dev,
            test, and prod environments, resulting in scalable infrastructure
            and monthly savings of approximately £2000.
          </ListItem>
          <ListItem>
          ...
          <ListItem>
            Generated cost evaluations using AWS Cost Calculator, showcasing
            cost reductions to senior management and offering future cost
            projections.
          </ListItem>
        </List>
        <Title order={2}>
          Graduate Program, JPMorgan (Sep 2020 - Sep 2022)
        </Title>
        <Title order={3}>
        ...
        <List>
          ...
          <ListItem>
            Led the integration of the trade booking API into the work
            management platform (Unity), reducing trade consolidation time by
            20%. Collaborated with UX on user journeys, MVP creation, and
            developers on implementation and testing.
          </ListItem>
          <ListItem>
            ...
            with users, design, and product teams to boost engagement and trust
        ...
        <List>
          <ListItem>
            Launched an EMEA-wide PRIDE mentorship program, supporting new
            joiners and aiding professional growth for LGBTQ+ employees.
          </ListItem>
          <ListItem>
            Hosted weekly PRIDE coffee mornings to foster connection, culture
            and a sense of community for LGBTQ+ people across the London offices
          </ListItem>
        </List>
        <Divider />
        ...
        <List>
          ...
          <ListItem>
            Interests: Sustainable Fashion, Hiking, Touch Designer, LGBTQ+
            Rights, Salsa Dancing
          </ListItem>
        </List>
      </div>
    </div>
